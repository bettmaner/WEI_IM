...
public class EmojiDao {
    ...
    public static String CopySqliteFileFromRawToDatabases(String SqliteFileName) throws IOException {
        ...
        //复制的话这里需要换成自己项目的包名
        File dir = new File("data/data/" + "edu.ncu.zww.app.wei_im" + "/databases");
        ...
        if (!file.exists()) {
            try {
                file.createNewFile();
                inputStream = MApplication.getInstance().getClass().getClassLoader().getResourceAsStream("assets/" + SqliteFileName);
